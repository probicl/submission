from .gym_environment import GymEnvironment, NormalizedStates, \
    ...
    AntWall, FollowGymAPI, WalkerWithPos, SwimmerWithPos
...
register(
    id="WalkerWithPos-v0",
    entry_point="tools.environments.gym_environment:WalkerWithPos",
...
register(
    ...
    entry_point="tools.environments.gym_environment:SwimmerWithPos",
    max_episode_steps=500,
    reward_threshold=None,
    nondeterministic=False,
)
register(
    ...
    max_episode_steps=500, # 1000 previously
    reward_threshold=None,
    nondeterministic=False,
)
register(
